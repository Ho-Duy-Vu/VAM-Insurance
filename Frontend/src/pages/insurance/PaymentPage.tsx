      ...
      try {
        ...
        if (user && user.id) {
          ...
          const purchaseData = {
            ...
            insurance_company: 'VAM Insurance',
                ...
                <CardContent>
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-8">
                    <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm mx-auto">
                      {/* VietQR Banking QR Code */}
                      <div className="aspect-square bg-white rounded-lg flex items-center justify-center mb-4 overflow-hidden">
                        <img 
                          src="https://img.vietqr.io/image/BIDV-7660314323-print.png" 
                          alt="VietQR Banking QR Code"
                      ...
                      <div className="text-center space-y-2">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                          <p className="text-xs text-gray-600 mb-1">Ngân hàng: BIDV</p>
                          <p className="text-xs text-gray-600">STK: 7660314323</p>
                        </div>
                      </div>
                    </div>
