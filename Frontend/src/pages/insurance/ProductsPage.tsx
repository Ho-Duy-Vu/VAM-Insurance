...
export default function ProductsPage() {
  ...
  const getProductDetailRoute = (productId: string): string => {
    const routeMap: Record<string, string> = {
      'health': '/packages/health-family', // Bảo hiểm sức khỏe → Gói gia đình
      'accident': '/packages/life-basic', // Tai nạn cá nhân → Nhân thọ cơ bản
      'social': '/packages/mandatory-health', // BHXH → Bảo hiểm y tế bắt buộc
      'travel': '/packages/health-international', // Du lịch → Y tế quốc tế
      'car': '/packages/vehicle-comprehensive', // Ô tô → Bảo hiểm xe toàn diện
      'home': '/natural-disaster/flood-basic', // Nhà cửa → Bảo hiểm ngập lụt (thiên tai)
      'business': '/packages/life-premium', // DN → Nhân thọ cao cấp (tạm thời)
      'life': '/packages/life-premium', // Nhân thọ → Nhân thọ VIP
      'children': '/packages/health-family' // Trẻ em → Sức khỏe gia đình
    }
