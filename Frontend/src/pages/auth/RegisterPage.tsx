...
import { Shield, Mail, Lock, Eye, EyeOff, User, Phone, Loader2, Droplets, Waves } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden px-4 py-12 bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-600">
      ...
      <div className="w-full max-w-md relative z-10 cascade-item">
        ...
        <Card className="glass-card shadow-2xl border-white/30 overflow-hidden cascade-item" style={{ animationDelay: '0.2s' }}>
          ...
          <CardHeader className="space-y-1 pt-8">
            ...
            <CardDescription className="text-center text-gray-700 font-medium">
              Bảo vệ tài sản của bạn với công nghệ AI
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.3s' }}>
                <label htmlFor="fullName" className="text-sm font-semibold text-gray-800 flex items-center gap-2">
                  <User className="w-4 h-4 text-blue-600" />
                  Họ và tên
                </label>
                <div className="relative group">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-500 group-focus-within:text-blue-600 transition-colors" />
                  <input
                    id="fullName"
                    name="fullName"
                    type="text"
                    ...
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-300 bg-white/80 backdrop-blur-sm font-medium ${errors.fullName
              ...
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-300 bg-white/80 backdrop-blur-sm font-medium ${errors.email
                        ? 'border-red-400 focus:ring-red-200 focus:border-red-500'
                        : 'border-blue-200 focus:ring-blue-200 focus:border-blue-500 hover:border-blue-300'
                      }`}
              ...
              {/* Phone */}
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.5s' }}>
                <label htmlFor="phone" className="text-sm font-semibold text-gray-800 flex items-center gap-2">
                  <Phone className="w-4 h-4 text-blue-600" />
                  Số điện thoại
                </label>
                <div className="relative group">
                  <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-500 group-focus-within:text-blue-600 transition-colors" />
                  <input
                    id="phone"
                    name="phone"
                    type="tel"
                    ...
                    onChange={handleChange}
                    className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-300 bg-white/80 backdrop-blur-sm font-medium ${errors.phone
                        ? 'border-red-400 focus:ring-red-200 focus:border-red-500'
                        : 'border-blue-200 focus:ring-blue-200 focus:border-blue-500 hover:border-blue-300'
                      }`}
              ...
              {/* Password */}
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.6s' }}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-11 pr-12 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-300 bg-white/80 backdrop-blur-sm font-medium ${errors.password
                        ? 'border-red-400 focus:ring-red-200 focus:border-red-500'
                        : 'border-blue-200 focus:ring-blue-200 focus:border-blue-500 hover:border-blue-300'
                      }`}
                    placeholder="••••••••"
              ...
              {/* Confirm Password */}
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.7s' }}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-11 pr-12 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-300 bg-white/80 backdrop-blur-sm font-medium ${errors.confirmPassword
                        ? 'border-red-400 focus:ring-red-200 focus:border-red-500'
                        : 'border-blue-200 focus:ring-blue-200 focus:border-blue-500 hover:border-blue-300'
                      }`}
                    placeholder="••••••••"
              ...
              {/* Terms & Conditions */}
              <div className="space-y-2 cascade-item" style={{ animationDelay: '0.8s' }}>
                <label className="flex items-start gap-2 cursor-pointer group">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-4 h-4 mt-1 text-blue-600 border-2 rounded focus:ring-blue-500 focus:ring-2 transition-all cursor-pointer ${errors.agreeTerms ? 'border-red-400' : 'border-blue-300'
                      }`}
                  />
          ...
          <CardFooter className="flex flex-col space-y-4 pb-8">
            <div className="text-center text-sm text-gray-700 font-medium cascade-item" style={{ animationDelay: '1.0s' }}>
              Đã có tài khoản?{' '}
              <Link
                to="/login"
            ...
            {/* Divider */}
            <div className="relative w-full cascade-item" style={{ animationDelay: '1.1s' }}>
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t-2 border-blue-200"></div>
              </div>
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white/80 backdrop-blur-sm px-3 py-1 text-gray-600 font-semibold rounded-full">Hoặc đăng ký với</span>
              </div>
            </div>

            {/* Social Register */}
            <div className="grid grid-cols-2 gap-3 cascade-item" style={{ animationDelay: '1.2s' }}>
              <Button
                type="button"
                variant="outline"
        ...
        {/* Footer */}
        <p className="text-center text-sm text-cyan-100 mt-6 font-medium drop-shadow-lg cascade-item" style={{ animationDelay: '1.3s' }}>
